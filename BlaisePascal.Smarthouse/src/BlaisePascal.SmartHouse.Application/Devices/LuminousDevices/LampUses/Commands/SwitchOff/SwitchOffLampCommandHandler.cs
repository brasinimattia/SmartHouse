...
{
    public sealed class SwitchOffLampCommandHandler : IRequestHandler<SwitchOffLampCommand, Result<Guid>>
    {
        private readonly ILampRepository _lampRepository;
        public SwitchOffLampCommandHandler(ILampRepository lampRepository)
        {
            _lampRepository = lampRepository;
        }
        public Task<Result<Guid>> Handle(SwitchOffLampCommand request, CancellationToken cancellationToken)
        {
